...
public class ModItems {
    ...
    public static void initialize() {
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FUNCTIONAL)
                .register((itemGroup) -> {
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.PINK_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.PINK_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.MAGENTA_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.MAGENTA_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.PURPLE_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.PURPLE_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.BLUE_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.BLUE_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.LIGHT_BLUE_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.LIGHT_BLUE_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.CYAN_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.CYAN_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.GREEN_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.GREEN_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.LIME_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.LIME_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.YELLOW_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.YELLOW_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.ORANGE_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.ORANGE_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.RED_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.RED_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.BROWN_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.BROWN_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.BLACK_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.BLACK_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.GRAY_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.GRAY_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.LIGHT_GRAY_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.LIGHT_GRAY_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.WHITE_MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.WHITE_MUSHROOM_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.MUSHROOM_HANGING_SIGN);
                    itemGroup.addAfter(Items.BAMBOO_HANGING_SIGN, ModItems.MUSHROOM_SIGN);
                });
    }
}
